...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // Dev3_1. Create a variable that filters the metadata array for the object with the desired sample number.
    ...
    // Dev3_2. Create a variable that holds the first sample in the metadata array.
